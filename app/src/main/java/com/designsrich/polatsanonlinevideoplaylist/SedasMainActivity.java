...
public class SedasMainActivity extends Activity implements View.OnClickListener {
    private Handler handler2;
    private Runnable r;
    private static String TAG = "SedasMainActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText( SedasMainActivity.this, "Lütfen Bekleyin. Video Oynatıcı Sayfasına Yönlendiriliyorsunuz...", Toast.LENGTH_LONG ).show();
                Intent intent = new Intent( SedasMainActivity.this,PolatsanAnaActivity.class );
        ...
        r = new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(SedasMainActivity.this, "Oturum İşleminiz doldu.", Toast.LENGTH_SHORT).show();
            }
        };
