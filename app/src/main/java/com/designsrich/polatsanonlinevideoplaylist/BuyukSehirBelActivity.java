...
public class BuyukSehirBelActivity extends Activity implements View.OnClickListener {
    private Handler handler2;
    private Runnable r;
    private static String TAG = "BuyukSehirBelActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setUpWidgets();
        setupBrowser("https://www.beykoz.bel.tr/");
        ...
        fab.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText( BuyukSehirBelActivity.this, "Lütfen Bekleyin. Video Oynatıcı Sayfasına Yönlendiriliyorsunuz...", Toast.LENGTH_LONG ).show();
                Intent intent = new Intent( BuyukSehirBelActivity.this,PolatsanAnaActivity.class );
        ...
        r = new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(BuyukSehirBelActivity.this, "Oturum İşleminiz doldu.", Toast.LENGTH_SHORT).show();
            }
        };
    ...
    private void setupBrowser(String url) {
        ...
        myWebChromeClient = new MyWebChromeClient(BuyukSehirBelActivity.this, childLayout, browserLayout, titleText);
