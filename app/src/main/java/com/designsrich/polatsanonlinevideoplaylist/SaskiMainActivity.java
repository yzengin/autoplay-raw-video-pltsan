...
public class SaskiMainActivity extends Activity implements View.OnClickListener {
    private Handler handler2;
    private Runnable r;
    private static String TAG = "SaskiMainActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setUpWidgets();
        setupBrowser("https://beyazmasa.ibb.istanbul/application/beyazmasa");
        ...
        fab.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText( SaskiMainActivity.this, "Lütfen Bekleyin. Video Oynatıcı Sayfasına Yönlendiriliyorsunuz...", Toast.LENGTH_LONG ).show();
                Intent intent = new Intent( SaskiMainActivity.this,PolatsanAnaActivity.class );
        ...
        r = new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(SaskiMainActivity.this, "Oturum İşleminiz doldu.", Toast.LENGTH_SHORT).show();
            }
        };
    ...
    private void setupBrowser(String url) {
        ...
        myWebChromeClient = new MyWebChromeClient(SaskiMainActivity.this, childLayout, browserLayout, titleText);
