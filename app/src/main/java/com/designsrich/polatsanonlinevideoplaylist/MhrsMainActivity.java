...
public class MhrsMainActivity extends Activity implements View.OnClickListener {
    private Handler handler2;
    private Runnable r;
    private static String TAG = "MhrsMainActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setUpWidgets();
        setupBrowser("https://www.mhrs.gov.tr/");
        ...
        fab.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText( MhrsMainActivity.this, "Lütfen Bekleyin. Video Oynatıcı Sayfasına Yönlendiriliyorsunuz...", Toast.LENGTH_LONG ).show();
                Intent intent = new Intent( MhrsMainActivity.this,PolatsanAnaActivity.class );
        ...
        r = new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(MhrsMainActivity.this, "Oturum İşleminiz doldu.", Toast.LENGTH_SHORT).show();
            }
        };
    ...
    private void setupBrowser(String url) {
        ...
        myWebChromeClient = new MyWebChromeClient(MhrsMainActivity.this, childLayout, browserLayout, titleText);
