...
public class EdevletMainActivity extends Activity implements View.OnClickListener {
    private Handler handler2;
    private Runnable r;
    private static String TAG = "EdevletMainActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setUpWidgets();
        setupBrowser("https://giris.turkiye.gov.tr/");
        ...
        fab.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText( EdevletMainActivity.this, "Lütfen Bekleyin. Video Oynatıcı Sayfasına Yönlendiriliyorsunuz...", Toast.LENGTH_LONG ).show();
                Intent intent = new Intent( EdevletMainActivity.this,PolatsanAnaActivity.class );
        ...
        r = new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(EdevletMainActivity.this, "Oturum İşleminiz doldu.", Toast.LENGTH_SHORT).show();
            }
        };
    ...
    private void setupBrowser(String url) {
        ...
        myWebChromeClient = new MyWebChromeClient(EdevletMainActivity.this, childLayout, browserLayout, titleText);
